...
resolve(){
    ...
    mxpy --verbose contract call ${ADDRESS} --recall-nonce --pem=${OWNER} --gas-limit=100000000 \
        --function="resolve" \
        --proxy=${PROXY} --chain=D \
        --arguments $ARG_0 $USDC 9953629 0x0000000000000000050006bdc61ebbec719b07b4a7ebfd1fb215c0706e3c7ceb 0x73776170546f6b656e734669786564496e707574 0x5745474c442d643763366262 0x0209127ed2f1413c 0x00000000000000000500e7283876b9cebf5e885a63795bc8271543a5acfb7ceb 0x73776170546f6b656e734669786564496e707574 0x4d45582d646332383963 0x0756bf58e0ad16fb7bae \
        --send
}
...
MEX_AMOUNT=36261825172988574036248
